            ...
            <div class="col-md-5">
              <div class="widget">
                <div class="whead">
                  ...
                  <div class="btn-group">
                    <a href="" class="btn btn-primary" class="btn btn-default" data-message=""><i class="fa fa-share"></i> 行</a>
                    <a href="" class="btn btn-info" data-message=""><i class="fa fa-plus"></i> 列</a>
                    <a href="" class="btn btn-default" data-message=""><i class="fa fa-home"></i> 清洗完成</a>
                  </div>
                </div>
                <div class="wbody">
                  <table class="table">
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        <%--</select>--%>
                          ...
                          <div class="btn-group">
                            <button type="button" class="btn btn-primary dropdown-toggle" data-toggle="dropdown">列操作
                              <span class="caret"></span>
                            </button>
                            <ul class="dropdown-menu" role="menu">
                              <li><a href="#">替换子字符串</a></li>
